...
**Your answer:**
The Git pane, the Environment pane, the History pane, and the Connections pane. The git pane is used to track changes and transfer them to GitHub. The environment pane shows the objects that are currently loaded in R, the history pane shows commands that you have previously run in the R console, and the connections pane shows connections to external data sources.
